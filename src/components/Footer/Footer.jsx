...
import ic_email from './icons/ic_email.svg';
import ic_skype from './icons/ic_skype.svg';
import icon_geo from './icons/icon_geo.svg';
        ...
        <div className='row'>
          <div className='col col-lg p-0'>
            ...
            <div className='copyright'>
              <Link to='/fe-dev-diploma' className='logo__footer-link'>
                <span>Лого</span>
              </Link>
              <a
